...
[sectalign 4]
%line 161+0 bootloader.asm
times (((4) - (($-$$) % (4))) % (4)) nop
%line 162+1 bootloader.asm
disk_packet:
 db 0x10
 db 0x00
 dw 1
 ...
 dq 95
[sectalign 4]
%line 169+0 bootloader.asm
times (((4) - (($-$$) % (4))) % (4)) nop
%line 170+1 bootloader.asm
framebuffer dd 0
[sectalign 4]
%line 171+0 bootloader.asm
times (((4) - (($-$$) % (4))) % (4)) nop
%line 172+1 bootloader.asm
pitch dw 0
times 510 - ($ - $$) db 0
dw 0xAA55
...
%line 185+1 bootloader.asm

%line 191+1 bootloader.asm


%line 209+1 bootloader.asm
...
[sectalign 16]
%line 292+0 bootloader.asm
times (((16) - (($-$$) % (16))) % (16)) nop
%line 293+1 bootloader.asm
idt_descriptor:
 dw (256 * 8) - 1
 dd idt_buffer
...
%line 344+1 bootloader.asm
 dd isr32
%line 344+0 bootloader.asm
 dd isr33
 dd isr34
 dd isr35
 dd isr36
 ...
 dd isr254
 dd isr255
%line 347+0 bootloader.asm

%line 348+1 bootloader.asm
...
%line 200+1 bootloader.asm
 ...
 mov ebx, 0xFFFF
 call printstring
%line 206+1 bootloader.asm
 hlt
 jmp $
%line 457+1 bootloader.asm
DevNotAvail:
%line 194+1 bootloader.asm
 mov edi, [framebuffer]
 mov ecx, (800 * 600 * 2)
